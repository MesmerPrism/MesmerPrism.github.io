...
# Rusty Morphospace
 ...
 Rusty Morphospace is an AGPL-first Rust architecture for computational form.
 It separates simulation truth, spatial relation, runtime authority,
 renderer-neutral inspection, authoring, and Quest/headset validation so
 prototypes do not collapse into one monolithic XR app.

 Reviewed June 21, 2026.

 [Understand the architecture](https://mesmerprism.com/projects/rusty-morphospace.html#start-here)
 ...
 [Map this to HSI](https://mesmerprism.com/projects/rusty-morphospace.html#hsi-implementation-layer)
...
## Rusty Morphospace at a glance
 ...
 What exists now
 Public core repos, native Quest/OpenXR/Vulkan routes, Makepad/Hostess validation paths, app-build feature locks, Matter/Optics teaching models, and legacy Rusty XR material.

 What it is for
 Keeping simulation, relation state, command authority, visual inspection, and platform evidence separate.

 Not yet
 A finished mixed-ability HSI study app, clinical system, scaled robotic backend, or single XR product.

 Public source
 Device evidence
 Planned HSI authoring
 Legacy reference
 Not a clinical claim

 Current, planned, and not claimed

 Current
 Public Rust repos, contracts, feature-lock APK workflow, Quest native renderer evidence, Matter/Optics teaching models, and Rusty XR legacy reference material.

 Planned
 HSI-facing authoring, consent/provenance controls, participant mapping editors, replay, and version comparison.

 Not claimed
 Clinical effect, finished study app, scaled robotic backend, raw passthrough access from MediaProjection, or calibrated physiology.
...
## Plain terms
 ...
 SDF / ADF
 Signed-distance and adaptive-distance field diagnostics for inspecting form, collision, and target-space behavior.

 AHardwareBuffer
 Android hardware buffer transport, abbreviated as HWB in route names and validation notes.
