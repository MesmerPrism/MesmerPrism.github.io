...
`)}function Kl(e){let t=new Set,n=[];for(let r of e){let e=r.stimulus;if(e.texture_source===`none`)continue;let i=e.texture_source===`user_upload`?`texture_upload_${(e.texture_upload_sha256??ql(e.texture_upload_name??`unknown`)).slice(0,16)}`:`texture_${e.texture_mode}_${e.texture_seed}`;t.has(i)||(t.add(i),n.push({asset_id:i,source:e.texture_source===`user_upload`?`local_user_file_not_embedded`:`procedural_canvas_runtime`,license:e.texture_source===`user_upload`?`user-supplied-not-redistributed`:`project-generated`,texture_kind:e.texture_mode,texture_source:e.texture_source,texture_label:e.texture_label,texture_weight_f:e.texture_weight_f,texture_seed:e.texture_seed,upload_name:e.texture_upload_name,upload_mime_type:e.texture_upload_mime_type,upload_size_bytes:e.texture_upload_size_bytes,upload_sha256:e.texture_upload_sha256,texture_width_px:e.texture_width_px,texture_height_px:e.texture_height_px,import_note:`Texture metadata is recorded for reproducibility; uploaded image bytes are not embedded in the session export.`}))}return n}function ql(e){return e.toLowerCase().replace(/[^a-z0-9]+/g,`_`).replace(/^_+|_+$/g,``)||`unknown`}function Jl(e){if(e==null)return``;let t=String(e);return/[",\n\r]/.test(t)?`"${t.replace(/"/g,`""`)}"`:t}function Yl(){let e=navigator.userAgent;return e.includes(`Firefox`)?`firefox`:e.includes(`Edg/`)?`edge`:e.includes(`Chrome`)?`chrome`:e.includes(`Safari`)?`safari`:`unknown`}var Xl=2741,Zl=1024;function Ql(e,t,n){if(e===`matte`||e===`uploaded`)return null;let r=nu(512,512),i=ru(r),a=Et.clamp(t,0,1);e===`procedural_noise`?iu(i,n):e===`procedural_face`?au(i):(iu(i,n),i.save(),i.globalAlpha=a,au(i),i.restore());let o=new ci(r);return eu(o),o.name=tu(e),o}async function $l(e){if(!cu(e))throw Error(`Texture file must be an image.`);let[t,n]=await Promise.all([lu(e),uu(e)]),r=new ci(n.canvas);return eu(r),r.name=e.name||`uploaded_texture`,{texture:r,metadata:{textureUploadName:e.name||`uploaded_texture`,textureUploadMimeType:e.type||`application/octet-stream`,textureUploadSizeBytes:e.size,textureUploadSha256:t,textureWidthPx:n.sourceWidth,textureHeightPx:n.sourceHeight}}}function eu(e){e.colorSpace=Le,e.wrapS=r,e.wrapT=r,e.minFilter=u,e.magFilter=c,e.generateMipmaps=!0,e.needsUpdate=!0}function tu(e,t=null){switch(e){case`matte`:return`Matte`;case`procedural_face`:return`Procedural face`;case`procedural_noise`:return`Procedural noise`;case`blend_f`:return`Texture blend F`;case`uploaded`:return t?`Uploaded ${t}`:`Uploaded texture`}}function nu(e,t){let n=document.createElement(`canvas`);return n.width=e,n.height=t,n}function ru(e){let t=e.getContext(`2d`,{alpha:!1});if(!t)throw Error(`2D canvas context unavailable.`);return t}function iu(e,t){let{width:n,height:r}=e.canvas,i=e.createImageData(n,r),a=su(t);for(let e=0;e<i.data.length;e+=4){let t=a(),n=Math.round(145+t*82),r=n+Math.round(a()*26),o=Math.round(n*.76+a()*20),s=Math.round(n*.62+a()*16);i.data[e]=r,i.data[e+1]=o,i.data[e+2]=s,i.data[e+3]=255}e.putImageData(i,0,0)}function au(e){let{width:t,height:n}=e.canvas,r=t/2,i=n/2,a=e.createRadialGradient(r,i*.86,t*.06,r,i,t*.58);a.addColorStop(0,`#e0b49a`),a.addColorStop(.62,`#c99780`),a.addColorStop(1,`#9f6c5f`),e.fillStyle=a,e.fillRect(0,0,t,n),e.save(),e.globalAlpha=.35,e.fillStyle=`#8b5d57`,e.beginPath(),e.ellipse(r,i*1.02,t*.39,n*.46,0,0,Math.PI*2),e.fill(),e.restore(),ou(e,r-t*.13,i-n*.09,t*.055,n*.026,`#44312f`),ou(e,r+t*.13,i-n*.09,t*.055,n*.026,`#44312f`),e.strokeStyle=`#60413d`,e.lineWidth=Math.max(3,t*.009),e.lineCap=`round`,e.beginPath(),e.moveTo(r-t*.21,i-n*.145),e.quadraticCurveTo(r-t*.13,i-n*.18,r-t*.05,i-n*.14),e.moveTo(r+t*.21,i-n*.145),e.quadraticCurveTo(r+t*.13,i-n*.18,r+t*.05,i-n*.14),e.stroke();let o=e.createLinearGradient(r,i-n*.03,r,i+n*.17);o.addColorStop(0,`rgba(126, 82, 75, 0.16)`),o.addColorStop(1,`rgba(92, 54, 49, 0.42)`),e.fillStyle=o,e.beginPath(),e.ellipse(r,i+n*.06,t*.045,n*.14,0,0,Math.PI*2),e.fill(),ou(e,r-t*.035,i+n*.105,t*.021,n*.011,`#5b3935`),ou(e,r+t*.035,i+n*.105,t*.021,n*.011,`#5b3935`),e.strokeStyle=`#653f3c`,e.lineWidth=Math.max(4,t*.012),e.beginPath(),e.moveTo(r-t*.13,i+n*.245),e.quadraticCurveTo(r,i+n*.29,r+t*.13,i+n*.245),e.stroke()}function ou(e,t,n,r,i,a){e.fillStyle=a,e.beginPath(),e.ellipse(t,n,r,i,0,0,Math.PI*2),e.fill()}function su(e){let t=Math.max(1,Math.floor(e))>>>0;return()=>{t+=1831565813;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}function cu(e){return e.type.startsWith(`image/`)?!0:/\.(avif|bmp|gif|jpe?g|png|svg|webp)$/i.test(e.name)}async function lu(e){if(!globalThis.crypto?.subtle)return null;let t=await e.arrayBuffer(),n=await globalThis.crypto.subtle.digest(`SHA-256`,t);return Array.from(new Uint8Array(n),e=>e.toString(16).padStart(2,`0`)).join(``)}async function uu(e){if(`createImageBitmap`in globalThis)try{let t=await createImageBitmap(e),n=fu(t,t.width,t.height);return t.close(),n}catch{return du(e)}return du(e)}async function du(e){let t=URL.createObjectURL(e);try{let e=await new Promise((e,n)=>{let r=new Image;r.onload=()=>e(r),r.onerror=()=>n(Error(`Texture image could not be decoded.`)),r.src=t});return fu(e,e.naturalWidth,e.naturalHeight)}finally{URL.revokeObjectURL(t)}}function fu(e,t,n){let r=Math.min(1,Zl/Math.max(t,n)),i=Math.max(1,Math.round(t*r)),a=Math.max(1,Math.round(n*r)),o=nu(i,a);return ru(o).drawImage(e,0,0,i,a),{canvas:o,sourceWidth:t,sourceHeight:n}}function pu(e,t){let n=e.getAttribute(`position`),r=e.getAttribute(`uv`),i=e.getAttribute(`normal`),a=new Float32Array(n.count*3),o=new Float32Array(n.count*2),s=i?new Float32Array(n.count*3):null,c=1-_u(t.separation,0,.8);for(let e=0;e<n.count;e+=3){let t=mu(n,e),l=mu(n,e+1),u=mu(n,e+2),d=new K().addVectors(t,l).add(u).multiplyScalar(1/3);hu(a,r,o,e,t,d,c),hu(a,r,o,e+1,l,d,c),hu(a,r,o,e+2,u,d,c),s&&i&&(gu(i,s,e),gu(i,s,e+1),gu(i,s,e+2))}let l=new Er;return l.setAttribute(`position`,new dr(a,3)),l.setAttribute(`uv`,new dr(o,2)),s?l.setAttribute(`normal`,new dr(s,3)):l.computeVertexNormals(),l.computeBoundingBox(),l.computeBoundingSphere(),l}function mu(e,t){return new K(e.getX(t),e.getY(t),e.getZ(t))}function hu(e,t,n,r,i,a,o){let s=a.clone().add(i.clone().sub(a).multiplyScalar(o));e[r*3]=s.x,e[r*3+1]=s.y,e[r*3+2]=s.z,n[r*2]=t?.getX(r)??.5,n[r*2+1]=t?.getY(r)??.5}function gu(e,t,n){t[n*3]=e.getX(n),t[n*3+1]=e.getY(n),t[n*3+2]=e.getZ(n)}function _u(e,t,n){return Math.min(Math.max(e,t),n)}var vu=$(`scene-canvas`),yu=$(`scene-canvas`).parentElement??document.body,bu=$(`geometry-condition`),xu=$(`concavity-scale`),Su=$(`texture-mode`),Cu=$(`texture-weight-control`),wu=$(`texture-weight-f`),Tu=$(`texture-upload`),Eu=$(`texture-drop-zone`),Du=$(`texture-upload-status`),Ou=$(`feature-hole-mode`),ku=$(`mesh-resolution`),Au=$(`surface-render-mode`),ju=$(`triangle-separation-control`),Mu=$(`triangle-separation`),Nu=$(`rotation-speed`),Pu=$(`show-probe`),Fu=$(`probe-depth-control`),Iu=$(`probe-depth`),Lu=$(`key-light-intensity`),Ru=$(`key-light-azimuth`),zu=$(`key-light-elevation`),Bu=$(`fill-light-ratio`),Vu=$(`ambient-light-intensity`),Hu=$(`mask-reflectance`),Uu=$(`lighting-preset`),Wu=$(`confidence`),Gu=$(`enter-xr`),Ku=$(`fullscreen-stimulus`),qu=$(`stereoscope-mode`),Ju=$(`reset-view`),Yu=$(`record-trial`),Xu=$(`download-session`),Zu=$(`tooltip-layer`),Q={geometryCondition:`concave_face`,concavityScale:Number(xu.value),textureMode:Su.value,textureWeightF:Number(wu.value),textureSeed:Xl,textureSource:`none`,textureLabel:tu(`matte`),textureUploadName:null,textureUploadMimeType:null,textureUploadSizeBytes:null,textureUploadSha256:null,textureWidthPx:null,textureHeightPx:null,featureHoleMode:Ou.value,meshResolution:ku.value,surfaceRenderMode:Au.value,triangleSeparation:Number(Mu.value),lightingPreset:Uu.value,keyLightIntensity:Number(Lu.value),keyLightAzimuthDeg:Number(Ru.value),keyLightElevationDeg:Number(zu.value),fillLightRatio:Number(Bu.value),ambientLightIntensity:Number(Vu.value),maskReflectance:Number(Hu.value),rotationSpeed:Number(Nu.value),showProbe:Pu.checked,probeDepthOffsetM:Number(Iu.value)},Qu={sessionId:`HF_${new Date().toISOString().replace(/[-:.TZ]/g,``).slice(0,14)}`,webXrSupported:null,immersiveSessionEntered:!1,stereoscopeMode:!1,frameDropCount:0,estimatedRefreshHz:null,viewportSizePx:[window.innerWidth,window.innerHeight]},$u={globalResponse:`no_response`,localResponse:`no_response`,confidence:Number(Wu.value),trialStartedAtMs:performance.now()},ed=[],td=new Mn;td.background=new Y(1777437);var nd=0,rd=new K(0,0,.72),id=new K(0,0,0),ad=new aa(42,1,.01,20);ad.position.copy(rd);var od=new Gc({canvas:vu,antialias:!0,alpha:!1});od.setPixelRatio(Math.min(window.devicePixelRatio,2)),od.outputColorSpace=Le,od.xr.enabled=!0;var sd=new G,cd=new K,ld=new nl(ad,vu);ld.enableDamping=!0,ld.target.copy(id),ld.minDistance=.28,ld.maxDistance=1.4;var ud=new wn;ud.position.y=nd,td.add(ud);var dd=new Di({color:13212292,emissive:13212292,emissiveIntensity:.18,roughness:.92,metalness:0,clearcoat:0,clearcoatRoughness:.85,side:2});El(dd,Q.featureHoleMode);var fd=new Yr(new Er,dd);fd.name=gl,ud.add(fd);var pd=null,md=null,hd=null,gd=null,_d=Kd();ud.add(_d),Wd();var vd=new qi(16777215,7167058,2.4);td.add(vd);var yd=new ca(16777215,1.8);yd.position.set(-.25,.28,.7),td.add(yd);var bd=new ca(16772833,1);bd.position.set(.3,-.05,.35),td.add(bd),zd(),Ud(),Nd(),new ResizeObserver(qd).observe(yu),qd(),Qd(),wd(),ef(),Td(),Gd();var xd=performance.now(),Sd=0,Cd=xd;od.setAnimationLoop(e=>{let t=e-xd;if(xd=e,Sd+=1,t>45&&(Qu.frameDropCount+=1),e-Cd>800){let t=Math.round(Sd*1e3/(e-Cd));Qu.estimatedRefreshHz=t,$(`frame-status`).textContent=`${t} fps`,Sd=0,Cd=e}od.xr.isPresenting||(ud.rotation.y+=Q.rotationSpeed*Math.min(t/1e3,.05),ld.update()),od.xr.isPresenting?od.render(td,ad):Qu.stereoscopeMode?Yd():Jd()});function wd(){bu.addEventListener(`change`,()=>{Q.geometryCondition=bu.value,jd()}),xu.addEventListener(`input`,()=>{Q.concavityScale=Number(xu.value),jd()}),Su.addEventListener(`change`,()=>{Q.textureMode=Su.value,Nd()}),wu.addEventListener(`input`,()=>{if(Q.textureWeightF=Number(wu.value),Q.textureMode===`blend_f`){Nd();return}Qd()}),Tu.addEventListener(`change`,()=>{let e=Tu.files?.item(0);e&&Md(e)}),Eu.addEventListener(`dragover`,e=>{e.preventDefault(),e.dataTransfer&&(e.dataTransfer.dropEffect=`copy`),Eu.classList.add(`is-dragging`)}),Eu.addEventListener(`dragleave`,()=>{Eu.classList.remove(`is-dragging`)}),Eu.addEventListener(`drop`,e=>{e.preventDefault(),Eu.classList.remove(`is-dragging`);let t=e.dataTransfer?.files.item(0);t&&Md(t)}),Ou.addEventListener(`change`,()=>{Q.featureHoleMode=Ou.value,Dl(dd,Q.featureHoleMode),Qd()}),ku.addEventListener(`change`,()=>{Q.meshResolution=ku.value,jd()}),Au.addEventListener(`change`,()=>{Q.surfaceRenderMode=Au.value,jd()}),Mu.addEventListener(`input`,()=>{Q.triangleSeparation=Number(Mu.value),jd()}),Nu.addEventListener(`input`,()=>{Q.rotationSpeed=Number(Nu.value),Qd()}),Uu.addEventListener(`change`,()=>{Bd(Uu.value)}),Lu.addEventListener(`input`,()=>{Vd(),Q.keyLightIntensity=Number(Lu.value),zd(),Qd()}),Ru.addEventListener(`input`,()=>{Vd(),Q.keyLightAzimuthDeg=Number(Ru.value),zd(),Qd()}),zu.addEventListener(`input`,()=>{Vd(),Q.keyLightElevationDeg=Number(zu.value),zd(),Qd()}),Bu.addEventListener(`input`,()=>{Vd(),Q.fillLightRatio=Number(Bu.value),zd(),Qd()}),Vu.addEventListener(`input`,()=>{Vd(),Q.ambientLightIntensity=Number(Vu.value),zd(),Qd()}),Hu.addEventListener(`input`,()=>{Vd(),Q.maskReflectance=Number(Hu.value),Ud(),Qd()}),Pu.addEventListener(`change`,()=>{Q.showProbe=Pu.checked,_d.visible=Q.showProbe,Qd()}),Iu.addEventListener(`input`,()=>{Q.probeDepthOffsetM=Number(Iu.value),Wd(),Qd()}),Wu.addEventListener(`input`,()=>{$u.confidence=Number(Wu.value),Qd()}),document.querySelectorAll(`[data-global-response]`).forEach(e=>{e.addEventListener(`click`,()=>{$u.globalResponse=e.dataset.globalResponse,af(`[data-global-response]`,e)})}),document.querySelectorAll(`[data-local-response]`).forEach(e=>{e.addEventListener(`click`,()=>{$u.localResponse=e.dataset.localResponse,af(`[data-local-response]`,e)})}),Ju.addEventListener(`click`,()=>{ad.position.copy(rd),ld.target.copy(id),ud.rotation.set(0,0,0),ld.update()}),Ku.addEventListener(`click`,()=>{Dd()}),qu.addEventListener(`click`,()=>{Qu.stereoscopeMode=!Qu.stereoscopeMode,kd()}),document.addEventListener(`fullscreenchange`,()=>{Od()}),Yu.addEventListener(`click`,()=>{let e=Vl(Q,Qu,$u,ed.length+1);ed.push(e),$u.trialStartedAtMs=performance.now(),Qd()}),Xu.addEventListener(`click`,()=>{let e=Hl(Qu,ed);Ul(`${Qu.sessionId}_hollow_face_v0_session.json`,e)}),Gu.addEventListener(`click`,()=>{Ed()})}async function Td(){if(!navigator.xr){Qu.webXrSupported=!1,$(`xr-status`).textContent=`WebXR unavailable`,Gu.disabled=!0;return}try{Qu.webXrSupported=await navigator.xr.isSessionSupported(`immersive-vr`)}catch{Qu.webXrSupported=!1}$(`xr-status`).textContent=Qu.webXrSupported?`WebXR ready`:`WebXR unavailable`,Gu.disabled=!Qu.webXrSupported}async function Ed(){if(!navigator.xr||!Qu.webXrSupported)return;let e=od.xr.getSession();if(e){await e.end();return}try{let e=await navigator.xr.requestSession(`immersive-vr`,{optionalFeatures:[`local-floor`,`bounded-floor`]});e.addEventListener(`end`,()=>{Qu.immersiveSessionEntered=!1,Ad(),Gu.textContent=`Enter VR`}),await od.xr.setSession(e),Qu.immersiveSessionEntered=!0,Ad(),Gu.textContent=`Exit VR`}catch{Qu.immersiveSessionEntered=!1,$(`xr-status`).textContent=`WebXR declined`}}async function Dd(){if(!document.fullscreenEnabled){$(`xr-status`).textContent=`Fullscreen unavailable`;return}try{if(document.fullscreenElement===yu){await document.exitFullscreen();return}await yu.requestFullscreen({navigationUI:`hide`})}catch{$(`xr-status`).textContent=`Fullscreen declined`}}function Od(){let e=document.fullscreenElement===yu;Ku.classList.toggle(`is-selected`,e),Ku.setAttribute(`aria-pressed`,String(e)),Ku.textContent=e?`Exit Fullscreen`:`Fullscreen`,window.requestAnimationFrame(qd)}function kd(){yu.classList.toggle(`is-stereoscope`,Qu.stereoscopeMode),qu.classList.toggle(`is-selected`,Qu.stereoscopeMode),qu.setAttribute(`aria-pressed`,String(Qu.stereoscopeMode)),Ad()}function Ad(){$(`runtime-mode`).textContent=Qu.immersiveSessionEntered?`WebXR`:Qu.stereoscopeMode?`Flat Web Stereo`:`Flat Web`}function jd(){if(!pd)return;let e=bl(pd.baseGeometry,Q.geometryCondition,Q.concavityScale),t=Ml(e,Al(Q.meshResolution));e.dispose();let n=Q.surfaceRenderMode===`triangle_particles`?pu(t,{separation:Q.triangleSeparation}):t;n!==t&&t.dispose();let r=fd.geometry;fd.geometry=n,r.dispose(),Wd(),Qd()}async function Md(e){Rd(`Loading ${e.name||`image`}...`,!1);try{let t=hd;t&&t!==md&&t.dispose();let n=await $l(e);hd=n.texture,gd=n.metadata,Q.textureMode=`uploaded`,Su.value=`uploaded`,Nd()}catch(e){Rd(e instanceof Error?e.message:`Texture image could not be loaded.`,!0)}finally{Tu.value=``}}function Nd(){let e=null;Q.textureMode===`uploaded`?hd&&gd?(e=hd,Id(gd),Rd(`${gd.textureUploadName} · ${gd.textureWidthPx}x${gd.textureHeightPx}`,!1)):(Q.textureSource=`none`,Q.textureLabel=`No uploaded texture`,Ld(),Rd(`No uploaded texture`,!1)):Q.textureMode===`matte`?(Q.textureSource=`none`,Q.textureLabel=tu(`matte`),Ld()):(e=Ql(Q.textureMode,Q.textureWeightF,Q.textureSeed),Q.textureSource=`procedural`,Q.textureLabel=tu(Q.textureMode),Q.textureUploadName=null,Q.textureUploadMimeType=null,Q.textureUploadSizeBytes=null,Q.textureUploadSha256=null,Q.textureWidthPx=512,Q.textureHeightPx=512),Pd(e),Fd(e!==null),Qd()}function Pd(e){let t=md;t&&t!==e&&t!==hd&&t.dispose(),md=e,dd.map=e,dd.needsUpdate=!0}function Fd(e){e?(dd.color.set(16777215),dd.emissive.set(0),dd.emissiveIntensity=0):(dd.color.set(13212292),dd.emissive.set(13212292),dd.emissiveIntensity=.18),dd.needsUpdate=!0}function Id(e){Q.textureSource=`user_upload`,Q.textureLabel=tu(`uploaded`,e.textureUploadName),Q.textureUploadName=e.textureUploadName,Q.textureUploadMimeType=e.textureUploadMimeType,Q.textureUploadSizeBytes=e.textureUploadSizeBytes,Q.textureUploadSha256=e.textureUploadSha256,Q.textureWidthPx=e.textureWidthPx,Q.textureHeightPx=e.textureHeightPx}function Ld(){Q.textureUploadName=null,Q.textureUploadMimeType=null,Q.textureUploadSizeBytes=null,Q.textureUploadSha256=null,Q.textureWidthPx=null,Q.textureHeightPx=null}function Rd(e,t){Du.textContent=e,Du.classList.toggle(`is-error`,t)}function zd(){vd.intensity=Q.ambientLightIntensity,yd.intensity=Q.keyLightIntensity;let e=Et.degToRad(Q.keyLightAzimuthDeg),t=Et.degToRad(Q.keyLightElevationDeg),n=.8,r=Math.cos(t)*n;yd.position.set(Math.sin(e)*r,Math.sin(t)*n,Math.cos(e)*r),bd.intensity=Q.keyLightIntensity*Q.fillLightRatio,bd.position.set(-yd.position.x*.55,-yd.position.y*.2,yd.position.z*.5)}function Bd(e){if(Q.lightingPreset=e,e!==`custom`){let t=Ol[e];Q.keyLightIntensity=t.keyLightIntensity,Q.keyLightAzimuthDeg=t.keyLightAzimuthDeg,Q.keyLightElevationDeg=t.keyLightElevationDeg,Q.fillLightRatio=t.fillLightRatio,Q.ambientLightIntensity=t.ambientLightIntensity,Q.maskReflectance=t.maskReflectance,Hd()}zd(),Ud(),Qd()}function Vd(){Q.lightingPreset=`custom`,Uu.value=`custom`}function Hd(){Uu.value=Q.lightingPreset,Lu.value=String(Q.keyLightIntensity),Ru.value=String(Q.keyLightAzimuthDeg),zu.value=String(Q.keyLightElevationDeg),Bu.value=String(Q.fillLightRatio),Vu.value=String(Q.ambientLightIntensity),Hu.value=String(Q.maskReflectance)}function Ud(){let e=Et.clamp(Q.maskReflectance,0,1);dd.roughness=Et.lerp(.92,.34,e),dd.clearcoat=Et.lerp(0,.65,e),dd.clearcoatRoughness=Et.lerp(.85,.22,e),dd.needsUpdate=!0}function Wd(){if(_d.visible=Q.showProbe,!pd)return;let e=pd?xl(pd.baseGeometry,0,-.012,Q.geometryCondition,Q.concavityScale):new K,t=pd?xl(pd.baseGeometry,0,.01,Q.geometryCondition,Q.concavityScale):new K;_d.position.copy(e),_d.position.z+=Q.probeDepthOffsetM;let n=_d.children.find(e=>e.name===`nose-marker`);n&&(n.position.copy(t.sub(e)),n.position.z+=Q.probeDepthOffsetM)}async function Gd(){try{pd=await yl(),jd()}catch(e){console.error(e),$(`xr-status`).textContent=`Mesh load warning`}}function Kd(){let e=new wn;e.name=`probe_rod_001`;let t=new Ei({color:15984848,roughness:.7,metalness:0}),n=new Yr(new pi(.003,.003,.13,18),t);n.rotation.z=Math.PI/2,n.name=`depth-rod`,e.add(n);let r=new Ei({color:2246718,roughness:.55,metalness:0}),i=new Yr(new hi(.008,20,12),r);return i.name=`nose-marker`,e.add(i),e}function qd(){let e=yu.getBoundingClientRect(),t=Math.max(1,Math.floor(e.width)),n=Math.max(1,Math.floor(e.height));od.setSize(t,n,!1),ad.aspect=t/n,ad.updateProjectionMatrix(),Qu.viewportSizePx=[t,n]}function Jd(){od.getDrawingBufferSize(sd),od.setScissorTest(!1),od.setViewport(0,0,sd.x,sd.y),ad.aspect=sd.x/sd.y,ad.updateProjectionMatrix(),Zd(),od.render(td,ad)}function Yd(){od.getDrawingBufferSize(sd);let e=sd.x,t=sd.y,n=Math.floor(e/2),r=e-n;if(n<1||r<1){Jd();return}od.setScissorTest(!1),od.setViewport(0,0,e,t),od.clear(),od.setScissorTest(!0),Xd(0,n,t),Xd(n,r,t),od.setScissorTest(!1)}function Xd(e,t,n){od.setViewport(e,0,t,n),od.setScissor(e,0,t,n),ad.aspect=t/n,ad.updateProjectionMatrix(),Zd(),od.render(td,ad)}function Zd(){let e=fd.geometry.getAttribute(`position`);if(!e)return;fd.updateWorldMatrix(!0,!1);let t=1/0,n=-1/0,r=1/0,i=-1/0;for(let a=0;a<e.count;a+=1)cd.fromBufferAttribute(e,a),fd.localToWorld(cd),cd.project(ad),!(!Number.isFinite(cd.x)||!Number.isFinite(cd.y))&&(t=Math.min(t,cd.x),n=Math.max(n,cd.x),r=Math.min(r,cd.y),i=Math.max(i,cd.y));if(!Number.isFinite(t)||!Number.isFinite(r))return;let a=(t+n)/2,o=(r+i)/2;ad.projectionMatrix.elements[8]+=a,ad.projectionMatrix.elements[9]+=o,ad.projectionMatrixInverse.copy(ad.projectionMatrix).invert()}function Qd(){$(`concavity-output`).textContent=Q.concavityScale.toFixed(2),$(`texture-weight-output`).textContent=Q.textureWeightF.toFixed(2),$(`triangle-separation-output`).textContent=Q.triangleSeparation.toFixed(2),$(`rotation-output`).textContent=Q.rotationSpeed.toFixed(2),$(`key-light-intensity-output`).textContent=Q.keyLightIntensity.toFixed(2),$(`key-light-azimuth-output`).textContent=`${Math.round(Q.keyLightAzimuthDeg)}°`,$(`key-light-elevation-output`).textContent=`${Math.round(Q.keyLightElevationDeg)}°`,$(`fill-light-ratio-output`).textContent=Q.fillLightRatio.toFixed(2),$(`ambient-light-intensity-output`).textContent=Q.ambientLightIntensity.toFixed(2),$(`mask-reflectance-output`).textContent=Q.maskReflectance.toFixed(2),$(`probe-depth-output`).textContent=`${Q.probeDepthOffsetM.toFixed(3)} m`,$(`confidence-output`).textContent=String($u.confidence),$(`geometry-readout`).textContent=Q.geometryCondition===`concave_face`?`Concave`:`Convex`;let e=Q.textureMode===`uploaded`&&Q.textureSource===`user_upload`?`Uploaded texture`:Q.textureLabel;$(`texture-readout`).textContent=Q.featureHoleMode===`none`?e:`${e} / apertures ${Q.featureHoleMode}`,$(`resolution-readout`).textContent=jl(Q.meshResolution),$(`surface-readout`).textContent=Q.surfaceRenderMode===`continuous_mesh`?`Mesh ${kl(Q.lightingPreset)}`:`Particles ${Q.triangleSeparation.toFixed(2)} ${kl(Q.lightingPreset)}`,$(`trial-readout`).textContent=`Trials ${ed.length}`,$d()}function $d(){Cu.hidden=Q.textureMode!==`blend_f`,Eu.hidden=Q.textureMode!==`uploaded`,Du.hidden=Q.textureMode!==`uploaded`,ju.hidden=Q.surfaceRenderMode!==`triangle_particles`,Fu.hidden=!Q.showProbe}function ef(){let e=null;document.querySelectorAll(`[data-tooltip]`).forEach(t=>{t.addEventListener(`mouseenter`,()=>{e=t,tf(t)}),t.addEventListener(`mouseleave`,()=>{e===t&&(e=null),rf(t)}),t.addEventListener(`focusin`,()=>{e=t,tf(t)}),t.addEventListener(`focusout`,()=>{e===t&&(e=null),rf(t)})}),window.addEventListener(`resize`,()=>{e&&nf(e)}),document.addEventListener(`scroll`,()=>{e&&nf(e)},!0)}function tf(e){let t=e.dataset.tooltip;t&&(Zu.textContent=t,Zu.hidden=!1,e.setAttribute(`aria-describedby`,Zu.id),nf(e),window.requestAnimationFrame(()=>{Zu.classList.add(`is-visible`)}))}function nf(e){let t=e.getBoundingClientRect(),n=Math.min(296,window.innerWidth-24);Zu.style.width=`${n}px`,Zu.style.left=`0px`,Zu.style.top=`0px`;let r=Zu.getBoundingClientRect(),i=of(t.right-n,12,Math.max(12,window.innerWidth-n-12)),a=t.bottom+8,o=t.top-r.height-8,s=a+r.height<=window.innerHeight-12?a:Math.max(12,o);Zu.style.left=`${i}px`,Zu.style.top=`${s}px`}function rf(e){Zu.classList.remove(`is-visible`),Zu.hidden=!0,e?.removeAttribute(`aria-describedby`)}function af(e,t){document.querySelectorAll(e).forEach(e=>{e.classList.toggle(`is-selected`,e===t)})}function $(e){let t=document.getElementById(e);if(!t)throw Error(`Missing required element #${e}`);return t}function of(e,t,n){return Math.min(n,Math.max(t,e))}