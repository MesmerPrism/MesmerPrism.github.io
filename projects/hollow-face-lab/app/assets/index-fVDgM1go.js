...
void main() {
	...
	`}var oo=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new si(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
bool insideFeatureHole(vec3 point) {
  ...
  if (featureHoleMode == 1) {
    return leftEye || rightEye;
  }
  if (featureHoleMode == 2) {
    return leftEye || rightEye || mouth;
  }
  if (featureHoleMode == 3) {
    return leftEye || rightEye || mouth || leftNostril || rightNostril;
  }
  return false;
}`),n.fragmentShader=n.fragmentShader.replace(`#include <alphatest_fragment>`,`if (insideFeatureHole(vFeaturePosition)) {
  discard;
}
#include <alphatest_fragment>`),e.userData.featureHoleShader=n}}function Dl(e,t){e.userData.featureHoleModeIndex=Tl[t];let n=e.userData.featureHoleShader;if(n){n.uniforms.featureHoleMode.value=Tl[t];return}e.needsUpdate=!0}var Ol={baseline_virtual:{keyLightIntensity:1,keyLightAzimuthDeg:27,keyLightElevationDeg:0,fillLightRatio:.5,ambientLightIntensity:.35,maskReflectance:0},high_ambiguity:{keyLightIntensity:1.15,keyLightAzimuthDeg:0,keyLightElevationDeg:-30,fillLightRatio:.25,ambientLightIntensity:.45,maskReflectance:.05},concavity_revealing:{keyLightIntensity:1.35,keyLightAzimuthDeg:45,keyLightElevationDeg:58,fillLightRatio:.08,ambientLightIntensity:.12,maskReflectance:0},realistic_material:{keyLightIntensity:1.1,keyLightAzimuthDeg:27,keyLightElevationDeg:10,fillLightRatio:.45,ambientLightIntensity:.3,maskReflectance:.18},low_cue_matte:{keyLightIntensity:.22,keyLightAzimuthDeg:0,keyLightElevationDeg:0,fillLightRatio:1,ambientLightIntensity:.72,maskReflectance:0}};function kl(e){switch(e){case`baseline_virtual`:return`Baseline`;case`high_ambiguity`:return`High ambiguity`;case`concavity_revealing`:return`Concavity reveal`;case`realistic_material`:return`Realistic rough`;case`low_cue_matte`:return`Low-cue matte`;default:return`Custom`}}function Al(e){switch(e){case`subdivide_2`:return 2;case`subdivide_4`:return 4;case`subdivide_8`:return 8;default:return 1}}function jl(e){let t=Al(e);return t===1?`1x`:`${t}x`}function Ml(e,t){let n=Math.max(1,Math.floor(t));if(n<=1)return e.clone();let r=e.getAttribute(`position`),i=e.getAttribute(`uv`),a=e.getAttribute(`normal`),o=[],s=[],c=[];for(let e=0;e<r.count;e+=3){let t=Nl(r,i,a,e);for(let e=0;e<n;e+=1)for(let r=0;r<n-e;r+=1)Pl(o,s,c,t,n,e,r,e+1,r,e,r+1),e+r<n-1&&Pl(o,s,c,t,n,e+1,r,e+1,r+1,e,r+1)}let l=new Er;return l.setAttribute(`position`,new mr(o,3)),l.setAttribute(`uv`,new mr(s,2)),l.setAttribute(`normal`,new mr(c,3)),l.computeBoundingBox(),l.computeBoundingSphere(),l}function Nl(e,t,n,r){return{positions:[Il(e,r),Il(e,r+1),Il(e,r+2)],uvs:[Ll(t,r),Ll(t,r+1),Ll(t,r+2)],normals:[Rl(n,r),Rl(n,r+1),Rl(n,r+2)]}}function Pl(e,t,n,r,i,a,o,s,c,l,u){Fl(e,t,n,r,i,a,o),Fl(e,t,n,r,i,s,c),Fl(e,t,n,r,i,l,u)}function Fl(e,t,n,r,i,a,o){let s=a/i,c=o/i,l=1-s-c,u=zl(r.positions,l,s,c),d=Bl(r.uvs,l,s,c),f=zl(r.normals,l,s,c).normalize();e.push(u.x,u.y,u.z),t.push(d.x,d.y),n.push(f.x,f.y,f.z)}function Il(e,t){return new K(e.getX(t),e.getY(t),e.getZ(t))}function Ll(e,t){return new G(e?.getX(t)??.5,e?.getY(t)??.5)}function Rl(e,t){return new K(e?.getX(t)??0,e?.getY(t)??0,e?.getZ(t)??1)}function zl(e,t,n,r){return new K(e[0].x*t+e[1].x*n+e[2].x*r,e[0].y*t+e[1].y*n+e[2].y*r,e[0].z*t+e[1].z*n+e[2].z*r)}function Bl(e,t,n,r){return new G(e[0].x*t+e[1].x*n+e[2].x*r,e[0].y*t+e[1].y*n+e[2].y*r)}function Vl(e,t,n,r){let i=t.immersiveSessionEntered?`webxr`:`flat_web`,a=Wl(t),o=e.geometryCondition===`concave_face`?1:-1,s=e.showProbe?Number((o*.031*e.concavityScale+e.probeDepthOffsetM).toFixed(4)):0;return{schema_version:`hollow.face.trial.v0.1`,trial_id:`${t.sessionId}_T${String(r).padStart(4,`0`)}`,block_id:`v0_render_probe`,trial_index:r,task_type:`mixed_global_local`,deployment_mode:i,runtime_family:i===`webxr`?`webxr_threejs`:`flat_web_threejs`,capability_flags:a,stimulus:{stimulus_asset_id:gl,geometry_condition:e.geometryCondition,concavity_scale:Number(e.concavityScale.toFixed(3)),texture_mode:e.textureMode,texture_weight_f:Number(e.textureWeightF.toFixed(3)),texture_seed:e.textureSeed,texture_source:e.textureSource,texture_label:e.textureLabel,texture_upload_name:e.textureUploadName,texture_upload_mime_type:e.textureUploadMimeType,texture_upload_size_bytes:e.textureUploadSizeBytes,texture_upload_sha256:e.textureUploadSha256,texture_width_px:e.textureWidthPx,texture_height_px:e.textureHeightPx,feature_hole_mode:e.featureHoleMode,mesh_resolution:e.meshResolution,mesh_subdivision_segments:Al(e.meshResolution),surface_render_mode:e.surfaceRenderMode,triangle_separation:Number(e.triangleSeparation.toFixed(3)),lighting_preset:e.lightingPreset,key_light_intensity:Number(e.keyLightIntensity.toFixed(3)),key_light_azimuth_deg:Number(e.keyLightAzimuthDeg.toFixed(1)),key_light_elevation_deg:Number(e.keyLightElevationDeg.toFixed(1)),fill_light_ratio:Number(e.fillLightRatio.toFixed(3)),ambient_light_intensity:Number(e.ambientLightIntensity.toFixed(3)),mask_reflectance:Number(e.maskReflectance.toFixed(3)),face_width_m:.16,face_height_m:.22,face_depth_m:Number((.075*e.concavityScale).toFixed(3)),viewer_distance_m:.7,disparity_gain:null,parallax_gain:null,lighting_condition:e.lightingPreset,orientation_condition:`upright`},probe:e.showProbe?{probe_id:`probe_rod_001`,probe_class:`rod`,attachment_mode:`inside_hollow_volume`,region:`nose_cheek_span`,coordinates_m:[0,-.01,s],salience:.7}:null,global_response:n.globalResponse,local_response:n.localResponse,confidence:n.confidence,response_time_ms:Math.max(0,Math.round(performance.now()-n.trialStartedAtMs)),frame_drop_count:t.frameDropCount,quality_flags:t.immersiveSessionEntered?[]:t.webXrSupported===!1?[`webxr_unavailable`,`flat_web_fallback`]:[`flat_web_fallback`]}}function Hl(e,t){let n={schema_version:`hollow.face.capabilities.v0.1`,session_id:e.sessionId,deployment_mode:e.immersiveSessionEntered?`webxr`:`flat_web`,runtime_family:e.immersiveSessionEntered?`webxr_threejs`:`flat_web_threejs`,browser_name:Yl(),browser_version:null,webxr_supported:e.webXrSupported,webxr_session_mode:e.immersiveSessionEntered?`immersive-vr`:null,immersive_session_entered:e.immersiveSessionEntered,display_refresh_hz:e.estimatedRefreshHz,tracking_mode:e.immersiveSessionEntered?`xr_head_tracking`:`no_head_tracking`,input_mode:`mouse_keyboard`,viewport_size_px:e.viewportSizePx,flat_display_mode:e.stereoscopeMode?`duplicate_stereoscope_pair`:`mono_canvas`,capability_flags:Wl(e),quality_notes:e.webXrSupported===!1?[`WebXR immersive-vr unavailable in this browser context.`]:[]},r={schema_version:`hollow.face.session.v0.1`,session_id:e.sessionId,participant_id_hash:null,study_id:`hollow_face_lab_v0`,protocol_version:`v0-render-probe`,software_name:`hollow-face-web`,software_version:`0.1.0`,deployment_mode:n.deployment_mode,runtime_family:n.runtime_family,capability_flags:n.capability_flags,consent_version:null,notes:`V0 renderer package using the Apache-2.0 MediaPipe canonical face mesh.`},i={schema_version:`hollow.face.assets.v0.1`,session_id:e.sessionId,assets:[{asset_id:gl,source:_l,license:`Apache-2.0`,mesh_kind:`imported_mediapipe_canonical_obj`,texture_kind:`matte_uniform_material`,attribution:`MediaPipe canonical face model, Google AI Edge / MediaPipe authors.`,import_note:`Open neutral face topology for V0 render baseline; not a validation-standard hollow-face research mesh.`},...Kl(t)]},a=t.map(e=>({trial_id:e.trial_id,frame_drop_count:e.frame_drop_count,quality_flags:e.quality_flags}));return JSON.stringify({session:r,capabilities:n,assets_manifest:i,trials_jsonl:t.map(e=>JSON.stringify(e)).join(`
`),trials_csv:Gl(t),quality_log_jsonl:a.map(e=>JSON.stringify(e)).join(`
`)},null,2)}function Ul(e,t){let n=new Blob([t],{type:`application/json`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=e,document.body.append(i),i.click(),i.remove(),URL.revokeObjectURL(r)}function Wl(e){let t=new Set;return t.add(e.immersiveSessionEntered?`immersive_session_entered`:`flat_web_only`),t.add(e.immersiveSessionEntered?`stereo_hmd`:e.stereoscopeMode?`duplicate_stereoscope_pair`:`mono_display`),t.add(`mouse_keyboard`),e.webXrSupported&&t.add(`webxr_supported`),e.webXrSupported===!1&&t.add(`browser_limited`),e.frameDropCount>0&&t.add(`frame_drop_warning`),Array.from(t)}function Gl(e){let t=`trial_id.trial_index.deployment_mode.geometry_condition.concavity_scale.texture_mode.texture_weight_f.texture_seed.texture_source.texture_label.texture_upload_name.texture_upload_mime_type.texture_upload_size_bytes.texture_upload_sha256.texture_width_px.texture_height_px.feature_hole_mode.mesh_resolution.mesh_subdivision_segments.surface_render_mode.triangle_separation.lighting_preset.key_light_intensity.key_light_azimuth_deg.key_light_elevation_deg.fill_light_ratio.ambient_light_intensity.mask_reflectance.global_response.local_response.confidence.response_time_ms.frame_drop_count`.split(`.`),n=e.map(e=>[e.trial_id,e.trial_index,e.deployment_mode,e.stimulus.geometry_condition,e.stimulus.concavity_scale,e.stimulus.texture_mode,e.stimulus.texture_weight_f,e.stimulus.texture_seed,e.stimulus.texture_source,e.stimulus.texture_label,e.stimulus.texture_upload_name,e.stimulus.texture_upload_mime_type,e.stimulus.texture_upload_size_bytes,e.stimulus.texture_upload_sha256,e.stimulus.texture_width_px,e.stimulus.texture_height_px,e.stimulus.feature_hole_mode,e.stimulus.mesh_resolution,e.stimulus.mesh_subdivision_segments,e.stimulus.surface_render_mode,e.stimulus.triangle_separation,e.stimulus.lighting_preset,e.stimulus.key_light_intensity,e.stimulus.key_light_azimuth_deg,e.stimulus.key_light_elevation_deg,e.stimulus.fill_light_ratio,e.stimulus.ambient_light_intensity,e.stimulus.mask_reflectance,e.global_response,e.local_response,e.confidence,e.response_time_ms,e.frame_drop_count].map(Jl).join(`,`));return[t.join(`,`),...n].join(`
`)}function Kl(e){let t=new Set,n=[];for(let r of e){let e=r.stimulus;if(e.texture_source===`none`)continue;let i=e.texture_source===`user_upload`?`texture_upload_${(e.texture_upload_sha256??ql(e.texture_upload_name??`unknown`)).slice(0,16)}`:`texture_${e.texture_mode}_${e.texture_seed}`;t.has(i)||(t.add(i),n.push({asset_id:i,source:e.texture_source===`user_upload`?`local_user_file_not_embedded`:`procedural_canvas_runtime`,license:e.texture_source===`user_upload`?`user-supplied-not-redistributed`:`project-generated`,texture_kind:e.texture_mode,texture_source:e.texture_source,texture_label:e.texture_label,texture_weight_f:e.texture_weight_f,texture_seed:e.texture_seed,upload_name:e.texture_upload_name,upload_mime_type:e.texture_upload_mime_type,upload_size_bytes:e.texture_upload_size_bytes,upload_sha256:e.texture_upload_sha256,texture_width_px:e.texture_width_px,texture_height_px:e.texture_height_px,import_note:`Texture metadata is recorded for reproducibility; uploaded image bytes are not embedded in the session export.`}))}return n}function ql(e){return e.toLowerCase().replace(/[^a-z0-9]+/g,`_`).replace(/^_+|_+$/g,``)||`unknown`}function Jl(e){if(e==null)return``;let t=String(e);return/[",\n\r]/.test(t)?`"${t.replace(/"/g,`""`)}"`:t}function Yl(){let e=navigator.userAgent;return e.includes(`Firefox`)?`firefox`:e.includes(`Edg/`)?`edge`:e.includes(`Chrome`)?`chrome`:e.includes(`Safari`)?`safari`:`unknown`}var Xl=2741,Zl=1024;function Ql(e,t,n){if(e===`matte`||e===`uploaded`)return null;let r=nu(512,512),i=ru(r),a=Et.clamp(t,0,1);e===`procedural_noise`?iu(i,n):e===`procedural_face`?au(i):(iu(i,n),i.save(),i.globalAlpha=a,au(i),i.restore());let o=new ci(r);return eu(o),o.name=tu(e),o}async function $l(e){if(!cu(e))throw Error(`Texture file must be an image.`);let[t,n]=await Promise.all([lu(e),uu(e)]),r=new ci(n.canvas);return eu(r),r.name=e.name||`uploaded_texture`,{texture:r,metadata:{textureUploadName:e.name||`uploaded_texture`,textureUploadMimeType:e.type||`application/octet-stream`,textureUploadSizeBytes:e.size,textureUploadSha256:t,textureWidthPx:n.sourceWidth,textureHeightPx:n.sourceHeight}}}function eu(e){e.colorSpace=Le,e.wrapS=r,e.wrapT=r,e.minFilter=u,e.magFilter=c,e.generateMipmaps=!0,e.needsUpdate=!0}function tu(e,t=null){switch(e){case`matte`:return`Matte`;case`procedural_face`:return`Procedural face`;case`procedural_noise`:return`Procedural noise`;case`blend_f`:return`Texture blend F`;case`uploaded`:return t?`Uploaded ${t}`:`Uploaded texture`}}function nu(e,t){let n=document.createElement(`canvas`);return n.width=e,n.height=t,n}function ru(e){let t=e.getContext(`2d`,{alpha:!1});if(!t)throw Error(`2D canvas context unavailable.`);return t}function iu(e,t){let{width:n,height:r}=e.canvas,i=e.createImageData(n,r),a=su(t);for(let e=0;e<i.data.length;e+=4){let t=a(),n=Math.round(145+t*82),r=n+Math.round(a()*26),o=Math.round(n*.76+a()*20),s=Math.round(n*.62+a()*16);i.data[e]=r,i.data[e+1]=o,i.data[e+2]=s,i.data[e+3]=255}e.putImageData(i,0,0)}function au(e){let{width:t,height:n}=e.canvas,r=t/2,i=n/2,a=e.createRadialGradient(r,i*.86,t*.06,r,i,t*.58);a.addColorStop(0,`#e0b49a`),a.addColorStop(.62,`#c99780`),a.addColorStop(1,`#9f6c5f`),e.fillStyle=a,e.fillRect(0,0,t,n),e.save(),e.globalAlpha=.35,e.fillStyle=`#8b5d57`,e.beginPath(),e.ellipse(r,i*1.02,t*.39,n*.46,0,0,Math.PI*2),e.fill(),e.restore(),ou(e,r-t*.13,i-n*.09,t*.055,n*.026,`#44312f`),ou(e,r+t*.13,i-n*.09,t*.055,n*.026,`#44312f`),e.strokeStyle=`#60413d`,e.lineWidth=Math.max(3,t*.009),e.lineCap=`round`,e.beginPath(),e.moveTo(r-t*.21,i-n*.145),e.quadraticCurveTo(r-t*.13,i-n*.18,r-t*.05,i-n*.14),e.moveTo(r+t*.21,i-n*.145),e.quadraticCurveTo(r+t*.13,i-n*.18,r+t*.05,i-n*.14),e.stroke();let o=e.createLinearGradient(r,i-n*.03,r,i+n*.17);o.addColorStop(0,`rgba(126, 82, 75, 0.16)`),o.addColorStop(1,`rgba(92, 54, 49, 0.42)`),e.fillStyle=o,e.beginPath(),e.ellipse(r,i+n*.06,t*.045,n*.14,0,0,Math.PI*2),e.fill(),ou(e,r-t*.035,i+n*.105,t*.021,n*.011,`#5b3935`),ou(e,r+t*.035,i+n*.105,t*.021,n*.011,`#5b3935`),e.strokeStyle=`#653f3c`,e.lineWidth=Math.max(4,t*.012),e.beginPath(),e.moveTo(r-t*.13,i+n*.245),e.quadraticCurveTo(r,i+n*.29,r+t*.13,i+n*.245),e.stroke()}function ou(e,t,n,r,i,a){e.fillStyle=a,e.beginPath(),e.ellipse(t,n,r,i,0,0,Math.PI*2),e.fill()}function su(e){let t=Math.max(1,Math.floor(e))>>>0;return()=>{t+=1831565813;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}function cu(e){return e.type.startsWith(`image/`)?!0:/\.(avif|bmp|gif|jpe?g|png|svg|webp)$/i.test(e.name)}async function lu(e){if(!globalThis.crypto?.subtle)return null;let t=await e.arrayBuffer(),n=await globalThis.crypto.subtle.digest(`SHA-256`,t);return Array.from(new Uint8Array(n),e=>e.toString(16).padStart(2,`0`)).join(``)}async function uu(e){if(`createImageBitmap`in globalThis)try{let t=await createImageBitmap(e),n=fu(t,t.width,t.height);return t.close(),n}catch{return du(e)}return du(e)}async function du(e){let t=URL.createObjectURL(e);try{let e=await new Promise((e,n)=>{let r=new Image;r.onload=()=>e(r),r.onerror=()=>n(Error(`Texture image could not be decoded.`)),r.src=t});return fu(e,e.naturalWidth,e.naturalHeight)}finally{URL.revokeObjectURL(t)}}function fu(e,t,n){let r=Math.min(1,Zl/Math.max(t,n)),i=Math.max(1,Math.round(t*r)),a=Math.max(1,Math.round(n*r)),o=nu(i,a);return ru(o).drawImage(e,0,0,i,a),{canvas:o,sourceWidth:t,sourceHeight:n}}function pu(e,t){let n=e.getAttribute(`position`),r=e.getAttribute(`uv`),i=e.getAttribute(`normal`),a=new Float32Array(n.count*3),o=new Float32Array(n.count*2),s=i?new Float32Array(n.count*3):null,c=1-_u(t.separation,0,.8);for(let e=0;e<n.count;e+=3){let t=mu(n,e),l=mu(n,e+1),u=mu(n,e+2),d=new K().addVectors(t,l).add(u).multiplyScalar(1/3);hu(a,r,o,e,t,d,c),hu(a,r,o,e+1,l,d,c),hu(a,r,o,e+2,u,d,c),s&&i&&(gu(i,s,e),gu(i,s,e+1),gu(i,s,e+2))}let l=new Er;return l.setAttribute(`position`,new dr(a,3)),l.setAttribute(`uv`,new dr(o,2)),s?l.setAttribute(`normal`,new dr(s,3)):l.computeVertexNormals(),l.computeBoundingBox(),l.computeBoundingSphere(),l}function mu(e,t){return new K(e.getX(t),e.getY(t),e.getZ(t))}function hu(e,t,n,r,i,a,o){let s=a.clone().add(i.clone().sub(a).multiplyScalar(o));e[r*3]=s.x,e[r*3+1]=s.y,e[r*3+2]=s.z,n[r*2]=t?.getX(r)??.5,n[r*2+1]=t?.getY(r)??.5}function gu(e,t,n){t[n*3]=e.getX(n),t[n*3+1]=e.getY(n),t[n*3+2]=e.getZ(n)}function _u(e,t,n){return Math.min(Math.max(e,t),n)}var vu=$(`scene-canvas`),yu=$(`scene-canvas`).parentElement??document.body,bu=$(`geometry-condition`),xu=$(`concavity-scale`),Su=$(`texture-mode`),Cu=$(`texture-weight-control`),wu=$(`texture-weight-f`),Tu=$(`texture-upload`),Eu=$(`texture-drop-zone`),Du=$(`texture-upload-status`),Ou=$(`feature-hole-mode`),ku=$(`mesh-resolution`),Au=$(`surface-render-mode`),ju=$(`triangle-separation-control`),Mu=$(`triangle-separation`),Nu=$(`rotation-speed`),Pu=$(`show-probe`),Fu=$(`probe-depth-control`),Iu=$(`probe-depth`),Lu=$(`key-light-intensity`),Ru=$(`key-light-azimuth`),zu=$(`key-light-elevation`),Bu=$(`fill-light-ratio`),Vu=$(`ambient-light-intensity`),Hu=$(`mask-reflectance`),Uu=$(`lighting-preset`),Wu=$(`confidence`),Gu=$(`enter-xr`),Ku=$(`fullscreen-stimulus`),qu=$(`stereoscope-mode`),Ju=$(`reset-view`),Yu=$(`record-trial`),Xu=$(`download-session`),Zu=$(`tooltip-layer`),Q={geometryCondition:`concave_face`,concavityScale:Number(xu.value),textureMode:Su.value,textureWeightF:Number(wu.value),textureSeed:Xl,textureSource:`none`,textureLabel:tu(`matte`),textureUploadName:null,textureUploadMimeType:null,textureUploadSizeBytes:null,textureUploadSha256:null,textureWidthPx:null,textureHeightPx:null,featureHoleMode:Ou.value,meshResolution:ku.value,surfaceRenderMode:Au.value,triangleSeparation:Number(Mu.value),lightingPreset:Uu.value,keyLightIntensity:Number(Lu.value),keyLightAzimuthDeg:Number(Ru.value),keyLightElevationDeg:Number(zu.value),fillLightRatio:Number(Bu.value),ambientLightIntensity:Number(Vu.value),maskReflectance:Number(Hu.value),rotationSpeed:Number(Nu.value),showProbe:Pu.checked,probeDepthOffsetM:Number(Iu.value)},Qu={sessionId:`HF_${new Date().toISOString().replace(/[-:.TZ]/g,``).slice(0,14)}`,webXrSupported:null,immersiveSessionEntered:!1,stereoscopeMode:!1,frameDropCount:0,estimatedRefreshHz:null,viewportSizePx:[window.innerWidth,window.innerHeight]},$u={globalResponse:`no_response`,localResponse:`no_response`,confidence:Number(Wu.value),trialStartedAtMs:performance.now()},ed=[],td=new Mn;td.background=new Y(1777437);var nd=0,rd=1.34,id=.38,ad=.006,od=new K(0,0,.72),sd=new K(0,0,0),cd=new aa(42,1,.01,20);cd.position.copy(od);var ld=new Gc({canvas:vu,antialias:!0,alpha:!1});ld.setPixelRatio(Math.min(window.devicePixelRatio,2)),ld.outputColorSpace=Le,ld.xr.enabled=!0;var ud=new G,dd=new K,fd=new nl(cd,vu);fd.enabled=!1,fd.enableDamping=!1,fd.enablePan=!1,fd.enableRotate=!1,fd.enableZoom=!1,fd.target.copy(sd),fd.minDistance=.28,fd.maxDistance=1.4;var pd=new wn;pd.position.y=nd,td.add(pd);var md=null,hd=0,gd=0,_d=new Di({color:13212292,emissive:13212292,emissiveIntensity:.18,roughness:.92,metalness:0,clearcoat:0,clearcoatRoughness:.85,side:2});El(_d,Q.featureHoleMode);var vd=new Yr(new Er,_d);vd.name=gl,pd.add(vd);var yd=null,bd=null,xd=null,Sd=null,Cd=ef();pd.add(Cd),Qd();var wd=new qi(16777215,7167058,2.4);td.add(wd);var Td=new ca(16777215,1.8);Td.position.set(-.25,.28,.7),td.add(Td);var Ed=new ca(16772833,1);Ed.position.set(.3,-.05,.35),td.add(Ed),qd(),Zd(),Vd(),new ResizeObserver(tf).observe(yu),tf(),uf(),Ad(),jd(),ff(),Nd(),$d();var Dd=performance.now(),Od=0,kd=Dd;ld.setAnimationLoop(e=>{let t=e-Dd;if(Dd=e,Od+=1,t>45&&(Qu.frameDropCount+=1),e-kd>800){let t=Math.round(Od*1e3/(e-kd));Qu.estimatedRefreshHz=t,$(`frame-status`).textContent=`${t} fps`,Od=0,kd=e}ld.xr.isPresenting||(md===null&&(pd.rotation.y+=Q.rotationSpeed*Math.min(t/1e3,.05)),fd.update()),ld.xr.isPresenting?ld.render(td,cd):Qu.stereoscopeMode?rf():nf()});function Ad(){bu.addEventListener(`change`,()=>{Q.geometryCondition=bu.value,zd()}),xu.addEventListener(`input`,()=>{Q.concavityScale=Number(xu.value),zd()}),Su.addEventListener(`change`,()=>{Q.textureMode=Su.value,Vd()}),wu.addEventListener(`input`,()=>{if(Q.textureWeightF=Number(wu.value),Q.textureMode===`blend_f`){Vd();return}uf()}),Tu.addEventListener(`change`,()=>{let e=Tu.files?.item(0);e&&Bd(e)}),Eu.addEventListener(`dragover`,e=>{e.preventDefault(),e.dataTransfer&&(e.dataTransfer.dropEffect=`copy`),Eu.classList.add(`is-dragging`)}),Eu.addEventListener(`dragleave`,()=>{Eu.classList.remove(`is-dragging`)}),Eu.addEventListener(`drop`,e=>{e.preventDefault(),Eu.classList.remove(`is-dragging`);let t=e.dataTransfer?.files.item(0);t&&Bd(t)}),Ou.addEventListener(`change`,()=>{Q.featureHoleMode=Ou.value,Dl(_d,Q.featureHoleMode),uf()}),ku.addEventListener(`change`,()=>{Q.meshResolution=ku.value,zd()}),Au.addEventListener(`change`,()=>{Q.surfaceRenderMode=Au.value,zd()}),Mu.addEventListener(`input`,()=>{Q.triangleSeparation=Number(Mu.value),zd()}),Nu.addEventListener(`input`,()=>{Q.rotationSpeed=Number(Nu.value),uf()}),Uu.addEventListener(`change`,()=>{Jd(Uu.value)}),Lu.addEventListener(`input`,()=>{Yd(),Q.keyLightIntensity=Number(Lu.value),qd(),uf()}),Ru.addEventListener(`input`,()=>{Yd(),Q.keyLightAzimuthDeg=Number(Ru.value),qd(),uf()}),zu.addEventListener(`input`,()=>{Yd(),Q.keyLightElevationDeg=Number(zu.value),qd(),uf()}),Bu.addEventListener(`input`,()=>{Yd(),Q.fillLightRatio=Number(Bu.value),qd(),uf()}),Vu.addEventListener(`input`,()=>{Yd(),Q.ambientLightIntensity=Number(Vu.value),qd(),uf()}),Hu.addEventListener(`input`,()=>{Yd(),Q.maskReflectance=Number(Hu.value),Zd(),uf()}),Pu.addEventListener(`change`,()=>{Q.showProbe=Pu.checked,Cd.visible=Q.showProbe,uf()}),Iu.addEventListener(`input`,()=>{Q.probeDepthOffsetM=Number(Iu.value),Qd(),uf()}),Wu.addEventListener(`input`,()=>{$u.confidence=Number(Wu.value),uf()}),document.querySelectorAll(`[data-global-response]`).forEach(e=>{e.addEventListener(`click`,()=>{$u.globalResponse=e.dataset.globalResponse,gf(`[data-global-response]`,e)})}),document.querySelectorAll(`[data-local-response]`).forEach(e=>{e.addEventListener(`click`,()=>{$u.localResponse=e.dataset.localResponse,gf(`[data-local-response]`,e)})}),Ju.addEventListener(`click`,()=>{sf(),cd.zoom=1,pd.rotation.set(0,0,0)}),Ku.addEventListener(`click`,()=>{Fd()}),qu.addEventListener(`click`,()=>{Qu.stereoscopeMode=!Qu.stereoscopeMode,Ld()}),document.addEventListener(`fullscreenchange`,()=>{Id()}),Yu.addEventListener(`click`,()=>{let e=Vl(Q,Qu,$u,ed.length+1);ed.push(e),$u.trialStartedAtMs=performance.now(),uf()}),Xu.addEventListener(`click`,()=>{let e=Hl(Qu,ed);Ul(`${Qu.sessionId}_hollow_face_v0_session.json`,e)}),Gu.addEventListener(`click`,()=>{Pd()})}function jd(){vu.addEventListener(`pointerdown`,e=>{e.button===0&&(md=e.pointerId,hd=e.clientX,gd=pd.rotation.y,yu.classList.add(`is-dragging`),vu.setPointerCapture(e.pointerId),e.preventDefault())}),vu.addEventListener(`pointermove`,e=>{if(md!==e.pointerId)return;let t=e.clientX-hd;pd.rotation.y=gd+t*ad}),vu.addEventListener(`pointerup`,Md),vu.addEventListener(`pointercancel`,Md),vu.addEventListener(`lostpointercapture`,Md)}function Md(e){md===e.pointerId&&(vu.hasPointerCapture(e.pointerId)&&vu.releasePointerCapture(e.pointerId),md=null,yu.classList.remove(`is-dragging`))}async function Nd(){if(!navigator.xr){Qu.webXrSupported=!1,$(`xr-status`).textContent=`WebXR unavailable`,Gu.disabled=!0;return}try{Qu.webXrSupported=await navigator.xr.isSessionSupported(`immersive-vr`)}catch{Qu.webXrSupported=!1}$(`xr-status`).textContent=Qu.webXrSupported?`WebXR ready`:`WebXR unavailable`,Gu.disabled=!Qu.webXrSupported}async function Pd(){if(!navigator.xr||!Qu.webXrSupported)return;let e=ld.xr.getSession();if(e){await e.end();return}try{let e=await navigator.xr.requestSession(`immersive-vr`,{optionalFeatures:[`local-floor`,`bounded-floor`]});e.addEventListener(`end`,()=>{Qu.immersiveSessionEntered=!1,Rd(),Gu.textContent=`Enter VR`}),await ld.xr.setSession(e),Qu.immersiveSessionEntered=!0,Rd(),Gu.textContent=`Exit VR`}catch{Qu.immersiveSessionEntered=!1,$(`xr-status`).textContent=`WebXR declined`}}async function Fd(){if(!document.fullscreenEnabled){$(`xr-status`).textContent=`Fullscreen unavailable`;return}try{if(document.fullscreenElement===yu){await document.exitFullscreen();return}await yu.requestFullscreen({navigationUI:`hide`})}catch{$(`xr-status`).textContent=`Fullscreen declined`}}function Id(){let e=document.fullscreenElement===yu;Ku.classList.toggle(`is-selected`,e),Ku.setAttribute(`aria-pressed`,String(e)),Ku.textContent=e?`Exit Fullscreen`:`Fullscreen`,window.requestAnimationFrame(tf)}function Ld(){yu.classList.toggle(`is-stereoscope`,Qu.stereoscopeMode),qu.classList.toggle(`is-selected`,Qu.stereoscopeMode),qu.setAttribute(`aria-pressed`,String(Qu.stereoscopeMode)),Rd()}function Rd(){$(`runtime-mode`).textContent=Qu.immersiveSessionEntered?`WebXR`:Qu.stereoscopeMode?`Flat Web Stereo`:`Flat Web`}function zd(){if(!yd)return;let e=bl(yd.baseGeometry,Q.geometryCondition,Q.concavityScale),t=Ml(e,Al(Q.meshResolution));e.dispose();let n=Q.surfaceRenderMode===`triangle_particles`?pu(t,{separation:Q.triangleSeparation}):t;n!==t&&t.dispose();let r=vd.geometry;vd.geometry=n,r.dispose(),Qd(),uf()}async function Bd(e){Kd(`Loading ${e.name||`image`}...`,!1);try{let t=xd;t&&t!==bd&&t.dispose();let n=await $l(e);xd=n.texture,Sd=n.metadata,Q.textureMode=`uploaded`,Su.value=`uploaded`,Vd()}catch(e){Kd(e instanceof Error?e.message:`Texture image could not be loaded.`,!0)}finally{Tu.value=``}}function Vd(){let e=null;Q.textureMode===`uploaded`?xd&&Sd?(e=xd,Wd(Sd),Kd(`${Sd.textureUploadName} · ${Sd.textureWidthPx}x${Sd.textureHeightPx}`,!1)):(Q.textureSource=`none`,Q.textureLabel=`No uploaded texture`,Gd(),Kd(`No uploaded texture`,!1)):Q.textureMode===`matte`?(Q.textureSource=`none`,Q.textureLabel=tu(`matte`),Gd()):(e=Ql(Q.textureMode,Q.textureWeightF,Q.textureSeed),Q.textureSource=`procedural`,Q.textureLabel=tu(Q.textureMode),Q.textureUploadName=null,Q.textureUploadMimeType=null,Q.textureUploadSizeBytes=null,Q.textureUploadSha256=null,Q.textureWidthPx=512,Q.textureHeightPx=512),Hd(e),Ud(e!==null),uf()}function Hd(e){let t=bd;t&&t!==e&&t!==xd&&t.dispose(),bd=e,_d.map=e,_d.needsUpdate=!0}function Ud(e){e?(_d.color.set(16777215),_d.emissive.set(0),_d.emissiveIntensity=0):(_d.color.set(13212292),_d.emissive.set(13212292),_d.emissiveIntensity=.18),_d.needsUpdate=!0}function Wd(e){Q.textureSource=`user_upload`,Q.textureLabel=tu(`uploaded`,e.textureUploadName),Q.textureUploadName=e.textureUploadName,Q.textureUploadMimeType=e.textureUploadMimeType,Q.textureUploadSizeBytes=e.textureUploadSizeBytes,Q.textureUploadSha256=e.textureUploadSha256,Q.textureWidthPx=e.textureWidthPx,Q.textureHeightPx=e.textureHeightPx}function Gd(){Q.textureUploadName=null,Q.textureUploadMimeType=null,Q.textureUploadSizeBytes=null,Q.textureUploadSha256=null,Q.textureWidthPx=null,Q.textureHeightPx=null}function Kd(e,t){Du.textContent=e,Du.classList.toggle(`is-error`,t)}function qd(){wd.intensity=Q.ambientLightIntensity,Td.intensity=Q.keyLightIntensity;let e=Et.degToRad(Q.keyLightAzimuthDeg),t=Et.degToRad(Q.keyLightElevationDeg),n=.8,r=Math.cos(t)*n;Td.position.set(Math.sin(e)*r,Math.sin(t)*n,Math.cos(e)*r),Ed.intensity=Q.keyLightIntensity*Q.fillLightRatio,Ed.position.set(-Td.position.x*.55,-Td.position.y*.2,Td.position.z*.5)}function Jd(e){if(Q.lightingPreset=e,e!==`custom`){let t=Ol[e];Q.keyLightIntensity=t.keyLightIntensity,Q.keyLightAzimuthDeg=t.keyLightAzimuthDeg,Q.keyLightElevationDeg=t.keyLightElevationDeg,Q.fillLightRatio=t.fillLightRatio,Q.ambientLightIntensity=t.ambientLightIntensity,Q.maskReflectance=t.maskReflectance,Xd()}qd(),Zd(),uf()}function Yd(){Q.lightingPreset=`custom`,Uu.value=`custom`}function Xd(){Uu.value=Q.lightingPreset,Lu.value=String(Q.keyLightIntensity),Ru.value=String(Q.keyLightAzimuthDeg),zu.value=String(Q.keyLightElevationDeg),Bu.value=String(Q.fillLightRatio),Vu.value=String(Q.ambientLightIntensity),Hu.value=String(Q.maskReflectance)}function Zd(){let e=Et.clamp(Q.maskReflectance,0,1);_d.roughness=Et.lerp(.92,.34,e),_d.clearcoat=Et.lerp(0,.65,e),_d.clearcoatRoughness=Et.lerp(.85,.22,e),_d.needsUpdate=!0}function Qd(){if(Cd.visible=Q.showProbe,!yd)return;let e=yd?xl(yd.baseGeometry,0,-.012,Q.geometryCondition,Q.concavityScale):new K,t=yd?xl(yd.baseGeometry,0,.01,Q.geometryCondition,Q.concavityScale):new K;Cd.position.copy(e),Cd.position.z+=Q.probeDepthOffsetM;let n=Cd.children.find(e=>e.name===`nose-marker`);n&&(n.position.copy(t.sub(e)),n.position.z+=Q.probeDepthOffsetM)}async function $d(){try{yd=await yl(),zd()}catch(e){console.error(e),$(`xr-status`).textContent=`Mesh load warning`}}function ef(){let e=new wn;e.name=`probe_rod_001`;let t=new Ei({color:15984848,roughness:.7,metalness:0}),n=new Yr(new pi(.003,.003,.13,18),t);n.rotation.z=Math.PI/2,n.name=`depth-rod`,e.add(n);let r=new Ei({color:2246718,roughness:.55,metalness:0}),i=new Yr(new hi(.008,20,12),r);return i.name=`nose-marker`,e.add(i),e}function tf(){let e=yu.getBoundingClientRect(),t=Math.max(1,Math.floor(e.width)),n=Math.max(1,Math.floor(e.height));ld.setSize(t,n,!1),cd.aspect=t/n,cd.updateProjectionMatrix(),Qu.viewportSizePx=[t,n]}function nf(){ld.getSize(ud),ld.setScissorTest(!1),ld.setViewport(0,0,ud.x,ud.y),of(ud.x,ud.y),ld.render(td,cd)}function rf(){ld.getSize(ud);let e=Math.max(1,Math.floor(ud.x)),t=Math.max(1,Math.floor(ud.y)),n=Math.floor(e/2),r=e-n;if(n<1||r<1){nf();return}ld.setScissorTest(!1),ld.setViewport(0,0,e,t),ld.clear(),ld.setScissorTest(!0),af(0,n,t),af(n,r,t),ld.setScissorTest(!1)}function af(e,t,n){ld.setViewport(e,0,t,n),ld.setScissor(e,0,t,n),of(t,n),ld.render(td,cd)}function of(e,t){sf(),cd.aspect=e/t,cd.zoom=1,cd.updateProjectionMatrix(),cf()}function sf(){cd.position.copy(od),cd.up.set(0,1,0),cd.lookAt(sd),cd.updateMatrixWorld(!0),cd.matrixWorldInverse.copy(cd.matrixWorld).invert(),fd.target.copy(sd)}function cf(){let e=lf();if(!e)return;let t=e.maxX-e.minX,n=e.maxY-e.minY,r=Math.max(t,n);r>0&&(cd.zoom=Et.clamp(rd/r,id,1),cd.updateProjectionMatrix());let i=lf();if(!i)return;let a=(i.minX+i.maxX)/2,o=(i.minY+i.maxY)/2;cd.projectionMatrix.elements[8]+=a,cd.projectionMatrix.elements[9]+=o,cd.projectionMatrixInverse.copy(cd.projectionMatrix).invert()}function lf(){cd.updateMatrixWorld(!0),cd.matrixWorldInverse.copy(cd.matrixWorld).invert(),pd.updateWorldMatrix(!0,!0);let e=1/0,t=-1/0,n=1/0,r=-1/0,i=!1;return pd.traverseVisible(a=>{if(!(a instanceof Yr))return;let o=a.geometry.getAttribute(`position`);if(o)for(let s=0;s<o.count;s+=1)dd.fromBufferAttribute(o,s),a.localToWorld(dd),dd.project(cd),!(!Number.isFinite(dd.x)||!Number.isFinite(dd.y))&&(i=!0,e=Math.min(e,dd.x),t=Math.max(t,dd.x),n=Math.min(n,dd.y),r=Math.max(r,dd.y))}),!i||!Number.isFinite(e)||!Number.isFinite(n)?null:{minX:e,maxX:t,minY:n,maxY:r}}function uf(){$(`concavity-output`).textContent=Q.concavityScale.toFixed(2),$(`texture-weight-output`).textContent=Q.textureWeightF.toFixed(2),$(`triangle-separation-output`).textContent=Q.triangleSeparation.toFixed(2),$(`rotation-output`).textContent=Q.rotationSpeed.toFixed(2),$(`key-light-intensity-output`).textContent=Q.keyLightIntensity.toFixed(2),$(`key-light-azimuth-output`).textContent=`${Math.round(Q.keyLightAzimuthDeg)}°`,$(`key-light-elevation-output`).textContent=`${Math.round(Q.keyLightElevationDeg)}°`,$(`fill-light-ratio-output`).textContent=Q.fillLightRatio.toFixed(2),$(`ambient-light-intensity-output`).textContent=Q.ambientLightIntensity.toFixed(2),$(`mask-reflectance-output`).textContent=Q.maskReflectance.toFixed(2),$(`probe-depth-output`).textContent=`${Q.probeDepthOffsetM.toFixed(3)} m`,$(`confidence-output`).textContent=String($u.confidence),$(`geometry-readout`).textContent=Q.geometryCondition===`concave_face`?`Concave`:`Convex`;let e=Q.textureMode===`uploaded`&&Q.textureSource===`user_upload`?`Uploaded texture`:Q.textureLabel;$(`texture-readout`).textContent=Q.featureHoleMode===`none`?e:`${e} / apertures ${Q.featureHoleMode}`,$(`resolution-readout`).textContent=jl(Q.meshResolution),$(`surface-readout`).textContent=Q.surfaceRenderMode===`continuous_mesh`?`Mesh ${kl(Q.lightingPreset)}`:`Particles ${Q.triangleSeparation.toFixed(2)} ${kl(Q.lightingPreset)}`,$(`trial-readout`).textContent=`Trials ${ed.length}`,df()}function df(){Cu.hidden=Q.textureMode!==`blend_f`,Eu.hidden=Q.textureMode!==`uploaded`,Du.hidden=Q.textureMode!==`uploaded`,ju.hidden=Q.surfaceRenderMode!==`triangle_particles`,Fu.hidden=!Q.showProbe}function ff(){let e=null;document.querySelectorAll(`[data-tooltip]`).forEach(t=>{t.addEventListener(`mouseenter`,()=>{e=t,pf(t)}),t.addEventListener(`mouseleave`,()=>{e===t&&(e=null),hf(t)}),t.addEventListener(`focusin`,()=>{e=t,pf(t)}),t.addEventListener(`focusout`,()=>{e===t&&(e=null),hf(t)})}),window.addEventListener(`resize`,()=>{e&&mf(e)}),document.addEventListener(`scroll`,()=>{e&&mf(e)},!0)}function pf(e){let t=e.dataset.tooltip;t&&(Zu.textContent=t,Zu.hidden=!1,e.setAttribute(`aria-describedby`,Zu.id),mf(e),window.requestAnimationFrame(()=>{Zu.classList.add(`is-visible`)}))}function mf(e){let t=e.getBoundingClientRect(),n=Math.min(296,window.innerWidth-24);Zu.style.width=`${n}px`,Zu.style.left=`0px`,Zu.style.top=`0px`;let r=Zu.getBoundingClientRect(),i=_f(t.right-n,12,Math.max(12,window.innerWidth-n-12)),a=t.bottom+8,o=t.top-r.height-8,s=a+r.height<=window.innerHeight-12?a:Math.max(12,o);Zu.style.left=`${i}px`,Zu.style.top=`${s}px`}function hf(e){Zu.classList.remove(`is-visible`),Zu.hidden=!0,e?.removeAttribute(`aria-describedby`)}function gf(e,t){document.querySelectorAll(e).forEach(e=>{e.classList.toggle(`is-selected`,e===t)})}function $(e){let t=document.getElementById(e);if(!t)throw Error(`Missing required element #${e}`);return t}function _f(e,t,n){return Math.min(n,Math.max(t,e))}