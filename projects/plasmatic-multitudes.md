...
CSL JSON references: https://mesmerprism.com/projects/plasmatic-multitudes.references.csl.json
...
# Plasmatic Multitudes
 ...
 shared-swarm control discussion, mixed-ability HSI research questions,
...
## Avatar work, shared embodiment, and the next question

 Plasmatic Multitudes grows out of Till Holzapfel's work on semi-corporeal
 avatars at the Intangible Realities Lab, in the context of its Isness work
 and collaboration with aNUma. The lab's numadelic design lineage uses
 luminous bodies and fluid boundaries to explore experiences beyond everyday
 embodiment
 ...
 The current research direction, [Combinatorial Swarmability](https://mesmerprism.com/projects/combinatorial-swarmability.html),
 carries the question of a body's changing boundary into mixed-ability
 human–swarm interaction. Several people might shape one many-part form through
 different inputs and roles. The question is then how they recognize, negotiate,
 and revise their contributions. Shared embodiment provides a starting point;
 whether it supports more equitable participation requires its own evidence.
...
- [Combinatorial Swarmability](https://mesmerprism.com/projects/combinatorial-swarmability.html) — the current PhD direction in mixed-ability human–swarm interaction.
...
- Intangible Realities Lab. “[Isness](https://www.intangiblerealitieslab.org/projects/isness)” and “[Numadelic Flow](https://www.intangiblerealitieslab.org/projects/numadelic-flow).” Public project and aesthetic context. Accessed September 16, 2026.

- aNUma. “[Science](https://anuma.com/science).” Isness research context, not independent clinical evidence. Accessed September 16, 2026.
