...
Every checked-in product channel must remain `unpublished` with `release: null`;
...
The protected central run requires all five labs owners. Kiosk admission may
...
family, exact owner-manifest-plus-APK-plus-`LICENSE`-plus-`SOURCE-NOTICE.md`
release inventory, immutable non-latest GitHub prerelease readback,
listener-off default,
