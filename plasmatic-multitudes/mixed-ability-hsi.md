...
## Design stance
 ...
 The page moves in four steps. First, it explains why mixed-ability swarm-body interaction
 is an access problem, not just a control problem. Second, it defines the swarm body as a
 visual and social medium for shared agency. Third, it proposes a staged path through
 access-practice elicitation, exploration, encounter, and cooperative play. Fourth, it
 names the safeguards needed for consent, privacy, fatigue, authorship, repair, reuse, and
 later translation.
...
## What "swarm body" means here

 The word "swarm" can point in many directions, so this page narrows it at the
 beginning.

 For now, a swarm is a many-part visual body: particles, points, fields, light, aura, or
 animated matter that can gather, split, soften, pulse, reveal, hide, and recover. This
 matters because the first research problem is not material action. It is legible shared
 agency.

 Swarm as visual body

### Many parts, one readable relation

 The starting object is a body, field, atmosphere, or relation made from many
 visible parts.

 Swarm as interaction grammar

### Partial control without micromanagement

 The group can think in tendencies, fields, density, rhythm, attraction, repair,
 and roles without any participant controlling every part.

 Later translation

### Another medium, not the premise

 Some vocabulary may later be tested in tangible or deployed systems. That matters,
 but it is not the first object of study.
 ...
 decoration. Can a group understand who is shaping density, rhythm, boundary,
 visibility, repair, or pace? Can they change those mappings when they become unfair,
 tiring, private, or confusing?
 ...
 Later, some of this vocabulary may be tested outside the first visual setting. That
 later translation matters, but it should not define the first reading of the page.
...
### Physics as legibility
 ...
 elasticity, turbulence, viscosity, resistance, squash, rebound, and contact cues help
 the viewer read what is gathering, dispersing, pressing, leaking, striking, yielding,
 or recovering
 ...
 before any physical deployment is considered
 ...
 so collaborators can read effort and relation. The same principle can support a body
 that waits, yields, holds, refuses speed, or recovers after overload without requiring
 the system to simulate literal matter.
 ...
 In this first phase, physics is not a safety model. It is a language for relation. It
 helps participants understand what is gathering, dispersing, pressing, leaking,
 recovering, waiting, resisting, or yielding.
...
## Later horizon: physical and robotic translation

 This section is not needed for the first study. It asks what would change if a
 successful swarm-body mapping were later tested in tangible, spatial, or robotic
 systems.

 A successful swarm-body mapping is not automatically ready for another medium. A visual
 body can be emotionally legible while remaining physically unconstrained. A physical
 swarm can be technically correct while remaining socially unreadable. The translation
 problem begins only after the group has discovered mappings worth translating.
 ...
 staged constraint test. The swarm-body phase asks which physical cues make shared
 agency readable and inhabitable. The later translation phase asks which of those cues
 still work when the swarm must move mass through a room, stay safe around people,
 tolerate sensor uncertainty, and remain useful after errors.
...
- what survives across exploration, games, and later translation constraints.
 ...
 Physical systems add the final constraint: mass, safety, localization, maintenance, and
 failure.
